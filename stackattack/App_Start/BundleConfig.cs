    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                "~/Scripts/src/bower_components/jquery/dist/jquery.js"));

            bundles.Add(new ScriptBundle("~/bundles/angular").Include(
                "~/Scripts/src/bower_components/angular/angular.js",
                "~/Scripts/src/bower_components/angular-route/angular-route.js"));


            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                "~/Scripts/src/app/app.module.js",
                "~/Scripts/src/app/core/question.module.js",
                "~/Scripts/src/app/core/question.service.js",
