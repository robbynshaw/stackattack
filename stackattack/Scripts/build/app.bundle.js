...
/***/ (function(module, exports, __webpack_require__) {
	...
	var QuestionList = __webpack_require__(299);
	var Question = __webpack_require__(322);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Imports
	var $ = __webpack_require__(1);
	var simpleevent = __webpack_require__(300);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
	    ...
	    e.prototype = {
	        subscribe: function subscribe(name, subscriber) {
	            if (!subscriber) {
	                subscriber = name;
	                name = Util.NextGUID();
	            }
	        ...
	        subscribeOnce: function subscribeOnce(subscriber) {
	            this.tempSubscribers.push(subscriber);
	        },
	        unSubscribe: function unSubscribe(name) {
	            delete this.subscribers[name];
	        },
	        notify: function notify(args, type, msg) {
...
/***/ (function(module, exports) {
	...
	module.exports = function () {
	    ...
	    var GUIDCounter = function GUIDCounter() {
	        var count = 234;
	    ...
	    Date.prototype.toNiceString = function () {
	        ...
	        var s;
	        if (dat > new Date("01/01/2098") || dat.getTime() == new Date("01/01/2001 00:00:00").getTime() || dat.getTime() == new Date("01/01/1901 00:00:00").getTime()) {
	            s = "n/a";
	        } else {
	            s = U.PadWithZeros(dat.getFullYear()) + "-" + U.PadWithZeros(dat.getMonth() + 1) + "-" + U.PadWithZeros(dat.getDate()) + " " + U.PadWithZeros(hours) + ":" + U.PadWithZeros(dat.getMinutes()) + amPm;
	        }
	        return s;
	    };
	    ...
	    Date.prototype.toNiceTimeString = function () {
	        ...
	        if (dat > new Date("01/01/2098") || dat.getTime() == new Date("01/01/2001 00:00:00").getTime() || dat.getTime() == new Date("01/01/1901 00:00:00").getTime()) {
	            ...
	            s = U.PadWithZeros(hours) + ":" + U.PadWithZeros(dat.getMinutes()) + ":" + U.PadWithZeros(dat.getSeconds()) + amPm;
	        }
	        return s;
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(1);
	var simpleevent = __webpack_require__(300);
	var questionWrapperTemplate = __webpack_require__(325);
	var questionDetailTemplate = __webpack_require__(323);
	var answerDetailTemplate = __webpack_require__(324);
	var successMessageTemplate = __webpack_require__(326);
	    ...
	    function addAnswers(obj, args, $container) {
	        if (args.answers) {
	            for (var i = 0; i < args.answers.length; i++) {
	                ...
	                var $el = $(document.createElement('div')).addClass('answer-detail-item');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>"
	    ...
	    + "</h3>\r\n<div class=\"question-detail-item-body\">\r\n    "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = ((helper = (helper = helpers.body || (depth0 != null ? depth0.body : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"body","hash":{},"data":data}) : helper))) != null ? stack1 : "");
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"row question-detail\">\r\n</div>\r\n<div class=\"row answer-detail\">\r\n</div>";
	},"useData":true});
